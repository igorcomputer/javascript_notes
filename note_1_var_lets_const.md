...
var   - Устаревший способ объявления переменных 
      ...
      - Сейчас использовать не рекомендуется (но активно используют в старых скриптах)
...
- https://modernizr.com - Плагин для определения поддержки функциональности в браузерах               
